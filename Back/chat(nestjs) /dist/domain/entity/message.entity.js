...
], MessageEntity.prototype, "m_id", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => chat_entity_1.ChatRoomEntity, chatRoom => chatRoom.messages),
    (0, typeorm_1.JoinColumn)({ name: 'cr_id' }),
    __metadata("design:type", chat_entity_1.ChatRoomEntity)
], MessageEntity.prototype, "chatRoom", void 0);
